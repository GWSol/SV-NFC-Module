...
//Include new libs for SSL certification compatibility
//#include <time.h>
//#include <FS.h>
//#include <LittleFS.h>
...
//    return; // Cannot connect to anything w/o certs
//  }
  /******************************************************************************/
}
/******************************************************************************
  ...
  if (httpsResponseCode == 200) {
    ...
    if (httpsResponseBody.substring(11, 15) == "true")
    {
          ...
          httpsResponseBody.substring(26, 42) == "\"NFC Registered\"")
      {
        ...
        //Serial.println("Codev3 is successfully updated. This is a new feature.");
        Serial.println("Codev3 is successfully updated. This is a new feature.");
